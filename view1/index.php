        ...
        <meta name="viewport" content="width=device-width,initial-scale=1">
          ...
          <link href="../auth/css/bootstrap.min.css" rel="stylesheet">
            <link href="../auth/css/custom.css" rel="stylesheet">
              <link href="../auth/css/toaster.css" rel="stylesheet">
                <style>
                  a {
                  color: orange;
                  }
                ...
                <!--[if lt IE 9]><link href= "../auth/css/bootstrap-theme.css"rel= "stylesheet" >
...
<![endif]-->
  ...
  <!-- Libs -->
  <script src="../auth/js/angular.min.js"></script>
  <script src="../auth/js/angular-route.min.js"></script>
  <script src="../auth/js/angular-animate.min.js" ></script>
  <script src="../auth/js/toaster.js"></script>
  <script src="../auth/app/app.js"></script>
  <script src="../auth/app/data.js"></script>
  <script src="../auth/app/directives.js"></script>
  <script src="../auth/app/authCtrl.js"></script>
</html>
